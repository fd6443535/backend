...
exports.getRequestTimeline = async (req, res) => {
  try {
    const reqID = req.params.reqid || req.query.reqid || req.headers['reqid'];
...
exports.getDelegates = async (req, res) => {
  try {
    const EmpID = req.params.empid || req.query.empid || req.cookies.empid;
    const CompanyID = req.params.companyid || req.query.companyid || req.cookies.context.companyid;
